...
open class SCLAlertView: UIViewController {
    ...
    open var yOffset = 0.0
    open var textViewToButtonPadding = 0.0
    ...
    fileprivate func setup() {
        ...
        //contentView.frame = CGRect(x: 100, y: 10, width: 300, height: 600)
        // Circle View
    ...
    override open func viewWillLayoutSubviews() {
        ...
        viewTextHeight = CGFloat(viewTextHeight) + CGFloat(textViewToButtonPadding)
        ...
        viewText.frame = CGRect(x:12, y:y + 5, width: viewTextWidth, height:viewTextHeight  )
        // Text fields
    ...
    @objc open func updateDurationStatus() {
        ...
        for btn in buttons.filter({$0.showDurationStatus}) {
            let txt = "\(btn.initialTitle ?? "") (\(duration ?? 0))"
